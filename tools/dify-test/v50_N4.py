# -*- coding: utf-8 -*-
"""第50版 台本N4：引き継ぎに至らない相談で、お知らせが出る位置を見る（31往復）。
...
def grab(r,sub,key,exact=False):
    ...
    return None
user="t-50-N4"; conv=None; rows=[]; fi=0; prev=""; stop=""
...
os.makedirs("docs/loop/v50/N4",exist_ok=True)
json.dump({"script":"N4","user":user,"conversation_id":conv,"turns":rows},
          open("docs/loop/v50/N4/raw_N4_1.json","w",encoding="utf-8"),ensure_ascii=False,indent=1)
