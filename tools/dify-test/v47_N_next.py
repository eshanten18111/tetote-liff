...
d=json.load(open("docs/loop/v47/N/raw_N_1.json",encoding="utf-8"))
...
json.dump(d,open("docs/loop/v47/N/raw_N_1.json","w",encoding="utf-8"),ensure_ascii=False,indent=1)
